            ...
            <div className="flex-1 bg-[#131524] rounded-2xl p-6 border border-[#272b44] shadow-2xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-xs font-mono text-yellow-300 bg-yellow-400/10 px-3.5 py-1 rounded-full border border-yellow-400/30 font-semibold">
                    ...
                    return (
                      <div
                        ...
                        className={`w-1.5 rounded-full transition-all duration-150 ${
                          active
                            ? "bg-yellow-300 shadow-[0_0_14px_rgba(253,224,71,0.85)]"
                ...
                <div className="flex items-center justify-between bg-[#0b0c16] p-4 rounded-xl border border-[#23263d] mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base font-mono text-yellow-300 font-bold tracking-wider">
                  ...
                  <Button
                    ...
                    className="bg-yellow-300 hover:bg-yellow-200 text-slate-950 font-bold text-xs border-0 shadow-[0_0_15px_rgba(253,224,71,0.5)] px-4 py-2"
                  >
              ...
              <div className="text-xs text-slate-400 bg-[#0b0c16] p-3.5 rounded-xl border border-[#23263d] flex items-center gap-2">
                <span className="text-yellow-300 font-bold">💡 Tip:</span> Click on waveform bars to scrub time. Add speaker tags and transcripts to export diarization datasets.
              </div>
            </div>
            ...
            <div className="w-full md:w-96 bg-[#131524] rounded-2xl p-6 border border-[#272b44] shadow-2xl flex flex-col">
              <h4 className="text-white font-bold text-sm mb-4 flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <Tag size={15} className="text-yellow-300" /> Audio Segments
                </span>
                <span className="px-2.5 py-0.5 rounded-full bg-yellow-400/15 text-yellow-300 text-xs font-mono font-bold border border-yellow-400/30">
                ...
                {audioSegments.map((seg) => (
                  <div key={seg.id} className="p-4 rounded-xl bg-[#0c0d18] border border-[#22253b] hover:border-[#343956] transition-all space-y-2.5">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-mono text-yellow-300 font-bold bg-yellow-400/10 px-2.5 py-0.5 rounded border border-yellow-400/30">{seg.start} - {seg.end}</span>
                    ...
                    <textarea
                      ...
                      className="w-full text-xs bg-[#05060b] text-slate-100 p-3 rounded-lg border border-[#2b304a] outline-none focus:border-yellow-300 focus:ring-1 focus:ring-yellow-300 resize-none h-16 transition-all font-sans"
                    />
                    <button
          ...
          <div className="flex-1 flex flex-col p-6 gap-6 overflow-y-auto bg-[#0a0b14]">
            <div className="flex-1 bg-[#131524] rounded-2xl p-6 border border-[#272b44] shadow-2xl flex flex-col justify-between">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  <VideoIcon className="h-5 w-5 text-yellow-300" />
              ...
              <div className="h-72 bg-[#06070d] rounded-xl border border-[#23263d] relative overflow-hidden flex items-center justify-center mb-6 shadow-inner">
                ...
                <div className="absolute top-12 left-24 border-2 border-yellow-300 bg-yellow-400/20 backdrop-blur-sm rounded-lg px-3 py-1 text-xs font-mono font-bold text-yellow-200 shadow-[0_0_15px_rgba(253,224,71,0.5)]">
              ...
              <div className="bg-[#0b0c16] rounded-xl border border-[#23263d] p-4">
                <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider mb-3 flex items-center gap-2">
                  <Tag size={13} className="text-yellow-300" /> Tracked Objects Across Frames
                </h4>
                <div className="space-y-2.5 text-xs">
                  {videoTracks.map((vt) => (
                    <div key={vt.id} className="flex items-center justify-between p-3 rounded-lg bg-[#06070d] border border-[#23263d] hover:border-[#383e5c] transition-all">
                      ...
                      <span className="font-mono text-yellow-300 font-bold">Frames {vt.startFrame}-{vt.endFrame}</span>
            ...
            <div className="flex-1 bg-[#131524] rounded-2xl p-6 border border-[#272b44] shadow-2xl space-y-6">
              <div>
                <h3 className="text-white font-bold text-lg font-display mb-2 flex items-center gap-2">
                  <Sparkles className="h-5 w-5 text-yellow-300" /> Prompt & Entity Tagging (NER)
                </h3>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div
                    ...
                    className={`p-5 rounded-xl border cursor-pointer transition-all ${
                      rlhfRank === "B"
                        ? "bg-yellow-400/20 border-yellow-300 shadow-[0_0_25px_rgba(253,224,71,0.35)] scale-[1.02]"
                        : "bg-[#06070d] border-[#23263d] hover:border-[#3b4160] text-white"
                    }`}
                  >
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-xs font-bold text-yellow-300 uppercase tracking-wider">Model Response B</span>
                      {rlhfRank === "B" && <CheckCircle size={16} className="text-yellow-300" />}
                    </div>
                    <p className="text-xs text-slate-100 leading-relaxed mb-4 font-medium">
          ...
          <div className="flex-1 flex flex-col md:flex-row p-6 gap-6 overflow-y-auto bg-[#0a0b14]">
            <div className="flex-1 bg-[#131524] rounded-2xl p-6 border border-[#272b44] shadow-2xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2.5">
                    <Radar className="h-5 w-5 text-yellow-300" />
                ...
                <div className="h-80 bg-[#06070d] rounded-xl border border-[#23263d] relative overflow-hidden flex items-center justify-center mb-6 shadow-inner">
                  ...
                  <div className="absolute top-4 left-4 bg-[#0a0b14]/90 backdrop-blur-md p-4 rounded-xl border border-[#282c44] text-xs font-mono space-y-1.5 text-slate-100 shadow-xl">
                    <div>Polarization: <span className="text-yellow-300 font-bold">{selectedBand}</span></div>
                    <div>Wavelength: <span className="text-white font-bold">5.55 cm (C-band)</span></div>
                    <div>Incidence Angle: <span className="text-yellow-300 font-bold">38.2°</span></div>
                  </div>
                </div>
                ...
                <div className="space-y-2 bg-[#0b0c16] p-4 rounded-xl border border-[#23263d]">
                  <div className="flex justify-between text-xs text-slate-300 font-semibold">
                    ...
                    <span className="text-yellow-300">SAR Radar Overlay ({opacityOverlay}%)</span>
                  </div>
                  <input
                    type="range"
                    min={0}
                    ...
                    className="w-full accent-yellow-300 cursor-pointer h-2 bg-[#25293d] rounded-lg"
                  />
                </div>
              </div>
            </div>
