    ...
    <div className="min-h-screen bg-black text-white relative">
      ...
      <main className="pt-28 pb-20 relative z-10">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          {/* API CTA Banner */}
          <div className="rounded-2xl border border-white/20 bg-white/[0.04] p-6 mb-14 flex flex-col sm:flex-row items-center justify-between gap-4 backdrop-blur-md">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-xl bg-white/10">
                <Terminal className="h-6 w-6 text-white" />
              </div>
              <div>
                <h3 className="font-bold text-white">Samyam Python SDK</h3>
                <p className="text-sm text-white/70">
                  <code className="px-2 py-0.5 rounded bg-white/10 text-white font-mono text-xs border border-white/20">pip install samyam</code> — Get started in minutes
                </p>
              </div>
            </div>
            <Link
              to="/docs"
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-white text-black font-semibold text-sm hover:bg-white/90 transition-opacity shrink-0"
            >
          ...
          <div className="space-y-14">
            {integrationCategories.map((category) => (
              <section key={category.title}>
                <div className="mb-5">
                  <h2 className="text-2xl font-bold font-display text-white">{category.title}</h2>
                  ...
                  {category.integrations.map((integration) => {
                    ...
                    return (
                      <div
                        ...
                        className="rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-white/30 transition-all group"
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            <div className="p-2 rounded-lg bg-white/10 group-hover:bg-white/20 transition-colors">
                              <IntIcon className="h-5 w-5 text-white" />
                            </div>
          ...
          {/* Request Integration */}
          <section className="mt-16 rounded-2xl border border-white/20 bg-white/[0.03] p-8 text-center backdrop-blur-md">
            <h2 className="text-2xl font-bold font-display mb-3 text-white">Need a Custom Integration?</h2>
