      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Explore our production machine learning deployments, space situational awareness pipelines, and geospatial dataset case studies.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {cases.map((c, i) => (
            ...
            >
              <Link
                to={c.href}
                className="glass-card rounded-xl overflow-hidden group cursor-pointer hover:border-cosmic-teal/40 transition-all flex flex-col justify-between block h-full"
              >
                <div>
