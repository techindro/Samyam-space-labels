            ...
            <div className="relative z-10 flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <div className="flex gap-3 mt-2 justify-center">
                  ...
                  <a href="https://discord.gg/samyam" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-background border border-border/50 text-muted-foreground hover:text-cosmic-teal transition-colors">
