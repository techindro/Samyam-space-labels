...
const HeroSection = () => {
  return (
    <section className="relative min-h-[85vh] py-16 sm:py-20 lg:py-24 flex items-center justify-center overflow-hidden star-field">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(800px,90vw)] h-[min(800px,90vw)] bg-secondary/30 rounded-full blur-[120px]" />
      <div className="absolute top-1/3 right-1/4 w-[min(400px,60vw)] h-[min(400px,60vw)] bg-foreground/5 rounded-full blur-[100px]" />
