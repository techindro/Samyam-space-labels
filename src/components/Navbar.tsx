      ...
      <nav className="sticky top-0 z-50 w-full glass-card border-b border-border/30">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button size="sm" className="bg-gradient-to-r from-cosmic-purple to-cosmic-teal text-primary-foreground hover:opacity-90 border-0">
        ...
        {mobileOpen && (
          <div className="md:hidden glass-card border-t border-border/30 px-4 py-6 space-y-4">
            ...
            <div className="pt-4 border-t border-border/30 space-y-3">
              <a href="#" className="block text-sm text-muted-foreground">Log In</a>
              <Button size="sm" className="w-full bg-gradient-to-r from-cosmic-purple to-cosmic-teal text-primary-foreground border-0">
                Book a Demo <ArrowRight className="h-3 w-3 ml-1" />
              </Button>
            </div>
          </div>
